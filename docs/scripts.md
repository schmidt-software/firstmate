...
| `fm-no-mistakes-ci-recover.sh` | Diagnose and, with `--force`, recover the shared daemon from the stuck-`ci`-step gh-checks-cwd bug ([issue #3](https://github.com/schmidt-software/firstmate/issues/3)) |
